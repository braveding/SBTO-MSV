...
cv = cvpartition(size(X1,1), 'Holdout', 0.25);
...
% save('Aggregation_dataset.mat', 'X', 'Y', 'X_test', 'Y_test')
...
% save('Aggregation.mat', 'accuracy', 'meanAccuracy', 'parameters')
